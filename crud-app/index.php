      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="add-user-form" class="p-2" novalidate>
            ...
            <div class="mb-3">
              <input type="text" name="Versicherungsnummer" id="Versicherungsnummer" class="form-control form-control-lg" placeholder="Versicherungsnummer" required>
              <div class="invalid-feedback">Versicherungsnummer</div>
            </div>
