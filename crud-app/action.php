<?php
  ...
  if (isset($_POST['add'])) {
    ...
    if ($db->insert($Vorname, $Nachname, $Geburtsdatum, $Versicherungen_idVersicherungen, $Versicherungsnummer)) {
  ...
  if (isset($_POST['update'])) {
    ...
    if ($db->update($idPatienten, $Vorname, $Nachname, $Geburtsdatum, $Versicherungen_idVersicherungen, $Versicherungsnummer)) {
